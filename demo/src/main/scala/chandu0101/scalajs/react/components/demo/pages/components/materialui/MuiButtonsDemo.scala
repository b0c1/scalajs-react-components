...
object MuiButtonsDemo {
  ...
  lazy val raisedButtons: List[ReactNode] = List(
    MuiRaisedButton(label = "Default"),
    MuiRaisedButton(label = "Primary", primary = true),
    MuiRaisedButton(label = "Secondary", secondary = true),
    MuiRaisedButton(label = "Disabled", disabled = true)
  ...
  lazy val floatingActionButtons1: List[ReactNode] = List(
    MuiFloatingActionButton.withChildren()(MuiActionGrade()), MuiFloatingActionButton.withChildren(mini = true)(
      MuiActionGrade()
    ), MuiFloatingActionButton.withChildren(disabled = true)(MuiActionGrade()), MuiFloatingActionButton.withChildren(
      disabled = true,
      mini = true
    )(MuiActionGrade())
  )
  ...
  lazy val flatButtons: List[ReactNode] = List(
    MuiFlatButton(label = "Default"),
    MuiFlatButton(label = "Primary", primary = true),
    MuiFlatButton(label = "Secondary", secondary = true),
    MuiFlatButton(label = "Disabled", disabled = true)
  ...
  val component = ReactComponentB[Unit]("MuiButtonsDemo").render(
      P => {
        <.div(
          <.h3("Buttons"), CodeExample(code)(
