...
object MuiSwitchesDemo {
  ...
  val component = ReactComponentB[Unit]("MuiSwitchesDemo").stateless.backend(new Backend(_)).render(
      (P, S, B) => {
        <.div(
          <.h3("Checkbox"), CodeExample(checkBoxCode)(
            MuiCheckbox(
              name = "checkBoxName1",
              value = "checkboxValue1",
              onCheck = B.onCheckBoxClick,
              label = "get out of box",
              key = "check1"
            ), MuiCheckbox(
              name = "checkBoxName2",
              value = "checkboxValue2",
              onCheck = B.onCheckBoxClick,
              label = "see nature conciously",
              defaultChecked = true,
              key = "check2"
            ), MuiCheckbox(
              name = "checkBoxName3",
              ...
              disabled = true,
              label = "live every moment",
              key = "check3"
            )
          ), <.h3("Radiobutton"), CodeExample(radioButtonCode)(
            MuiRadioButton(
              name = "shipped",
              value = "light",
              label = "prepare for light speed",
              onCheck = B.onRadioButtonClick,
              key = "radio1"
            ), <.br(), MuiRadioButton(
              name = "shipped",
              value = "not_light",
          ...
          ), <.h3("Toggle"), CodeExample(toggleCode)(
            MuiToggle(
              onToggle = B.onToggle,
              name = "togllename1",
              value = "togllename1",
              label = "active thursters",
              defaultToggled = true,
              key = "toggle1"
            )
          )
